...
//    }
    ...
    //get a String valid
    public static LocalDate getDate(String message, LocalDate bound){
        String dateInput;
...
//        LocalDate currentDate = LocalDate.now();
    ...
    public static boolean confirm(String message){
        message = "\t\t\t" + message;
        String confirm = Input.getString(message, "PLEASE, TYPE [y|n]!!!");
    ...
    public static void header(){
        String format = "|%1$-15s|%2$-15s|%3$-15s|%4$-15s|%5$-15s|%6$-15s|%7$-15s\n";
        System.out.format(format, "InjectionID", "StudentID", "VaccineID", "FirstDay", "FirstPlace", "SecondDay", "SecondPlace");
        System.out.println("-------------------------------------------------------------------------------------" +
                           "-----------------------");
    }
